...
# @description This script will install Styled Logger. The script heavily borrows from
...
#
#   ```
#   curl -sSL https://raw.githubusercontent.com/megabyte-labs/styled-logger/master/local/install.sh | sh
#   ```

RELEASES_URL="https://github.com/megabyte-labs/styled-logger/releases"
