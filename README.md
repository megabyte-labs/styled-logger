...
<div align="center">
  ...
  <a href="https://github.com/ProfessorManhattan/styled-logger/blob/master/docs/CONTRIBUTING.md" title="Learn about contributing" target="_blank">
...
<!--TERMINALIZE![terminalizer_title](https://gitlab.com/megabyte-labs/go/cli/stylog/-/raw/master/docs/demo.gif)TERMINALIZE-->
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/ProfessorManhattan/styled-logger/issues). If you would like to contribute, please take a look at the [contributing guide](https://github.com/ProfessorManhattan/styled-logger/blob/master/docs/CONTRIBUTING.md).
